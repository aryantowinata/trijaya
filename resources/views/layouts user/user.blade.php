    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/home') }}">
                ...
                <div class="sidebar-brand-text mx-3">Tri Jaya </div>
            </a>
            ...
            <li class="nav-item {{ Nav::isRoute('user/daftar_produk') }}">
                <a class="nav-link" href="{{ route('user/daftar_produk') }}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>{{ __('Daftar Produk') }}</span></a>
            </li>
            ...
            <!-- Nav Item - Profile -->
            <li class="nav-item {{ Nav::isRoute('Userprofile') }}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('user.cart.index') }}">
                                ...
                                Order Anda
                                <span class="badge bg-danger">{{ $orderCount ?? 0 }}</span> <!-- Tambahkan span di sini -->
                            </a>
                        </li>
